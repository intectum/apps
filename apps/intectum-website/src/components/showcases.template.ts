...
import renderCarouselHTML from '../components/carousel.template';

const showcasesTemplate = projects.filter(project => project.name === 'astrum' || project.name === 'ludo');

const renderShowcasesHTML = () => `
  <div data-scroll-animation="" class="c-home-showcases u-container u-fc u-gap u-center">
    <h2>Showcases</h2>
    ${renderCarouselHTML(showcasesTemplate.map((showcase, index) => `
