const renderSharkHTML = () => `
  <svg xmlns="http://www.w3.org/2000/svg" height="192px" viewBox="0 0 576 512" class="c-boids__boid c-boids__boid--shark">
