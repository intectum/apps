...
const renderImageControlHTML = (initialValue?: string) => `
  <div data-init="image-control">
    <div class="u-fr u-justify--center">
      <button data-name="image-open" type="button" class="u-rounded--full u-aspect--1 u-bg-blue-light" style="width: 128px;">
        <img data-name="image" src="${initialValue ?? ''}" alt="Me" class="u-rounded--full u-aspect--1 u-bg-blue-light" style="width: 128px; display: ${initialValue ? 'block' : 'none'}; object-fit: cover;" />
